...
const UserAboutPage = () => {
  ...
  const fullText = `Welcome to our job portal, where we connect job seekers with top companies looking to hire talented professionals.
      ...
      <div className="about-container">
        <div className="about-cont-img">
          <div className="about-text">
            <h1>Who We are<br />& Our Smart Mission</h1>
            <p>
              Our mission is to simplify job searching by connecting seekers with the right employers through a transparent and user-friendly platform.
            </p>
          </div>
        </div>
